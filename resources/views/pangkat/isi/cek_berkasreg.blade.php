            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class=""><a href="{{url('pangkat/uploadreg')."/".$pns->id}}" aria-expanded="false">Upload berkas</a></li>
                  <li class="active"><a href="{{url('pangkat/cek_berkasreg')."/".$pns->id}}" aria-expanded="true">Cek berkas</a></li>
                </ul>
